...
import 'i_image_downloader/i_image_downloader.dart';

/// Cross-platform implementation of [IImageDownloader]
class ImageDownloaderImpl implements IImageDownloader {
  const ImageDownloaderImpl();
  ...
  /// Requests the right permissions depending on the platform/version
